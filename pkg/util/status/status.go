...
type Option interface {
	ApplyOption(mdb *mdbv1.ADMongoDBCommunity)
...
func Update(statusWriter client.StatusWriter, mdb *mdbv1.ADMongoDBCommunity, optionBuilder OptionBuilder) (reconcile.Result, error) {
